...
5. **内置提示词**: Amrita 已内置基础格式提示词，无需额外描述消息格式
...
Amrita 支持创建和管理多个提示词预设。在 WebUI 的「聊天管理 → 提示词预设」页面可以进行完整的 CRUD 操作。
...
提示词中可使用以下占位符，Amrita 在发送给 LLM 前会自动替换：
